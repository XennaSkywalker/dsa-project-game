...
g++ main.cpp Player.h GameState.h SaveManager.h ReplayManager.h DesicionTree.h TutorialManager.h -o server.exe -std=c++17 -D_WIN32_WINNT=0x0A00 -static -lws2_32 -lwsock32
